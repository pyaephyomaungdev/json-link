            ...
            {activeTab === 'vite-starter' && (
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Export-ready kit containing your exported locales, autogenerated <code className="font-mono">translations.d.ts</code>, an ultra-lightweight client loader (<code className="font-mono">i18n.ts</code>, ~120 lines, 0 dependencies), embedded Devtools Drawer (<code className="font-mono">&lt;JsonLinkDevtools /&gt;</code>), and the official AI Skill (<code className="font-mono">.agents/skills/</code>) bundled in the ZIP.
                </p>
                ...
                <div className="flex items-center gap-2 pt-2 border-t border-border/50 text-[11px] text-muted-foreground">
                  ...
                  <span>Includes <code className="font-mono text-primary font-semibold">&lt;JsonLinkDevtools /&gt;</code> drawer for in-browser key search, live in-memory tweaks, and 1-click Download / Copy JSON.</span>
                </div>
              </div>
            )}
