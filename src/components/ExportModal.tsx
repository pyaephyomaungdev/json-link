              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between flex-wrap gap-1">
                  <span className="font-semibold text-foreground flex items-center gap-1.5">
                    ...
                    React + Vite i18n Starter Kit (Export-Ready ZIP)
                  </span>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Export-ready kit containing your exported locales, autogenerated <code className="font-mono">translations.d.ts</code>, an ultra-lightweight client loader (<code className="font-mono">i18n.ts</code>, ~120 lines, 0 dependencies), and the official AI Skill (<code className="font-mono">.agents/skills/</code>) bundled in the ZIP.
                </p>
                ...
                <div className="flex items-start gap-2 p-2 rounded-md bg-background/80 border border-border/80 text-[11px] leading-relaxed">
                  <div className="flex items-center gap-1 font-semibold text-foreground shrink-0 mt-0.5">
                    <Zap className="size-3.5 text-amber-500 shrink-0" />
                    <span>Live Devtools:</span>
                  </div>
                  <span className="text-muted-foreground">
                    Includes <code className="font-mono text-primary font-semibold">&lt;JsonLinkDevtools /&gt;</code> drawer for in-browser key search, live in-memory tweaks, and 1-click Download / Copy JSON.
                  </span>
                </div>
              </div>
            )}
