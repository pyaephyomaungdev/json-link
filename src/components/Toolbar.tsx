      ...
      <div className="flex items-center gap-1.5 shrink-0">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56">
            ...
            {onOpenGitHubSync && (
              <DropdownMenuItem onClick={onOpenGitHubSync} className="items-start gap-2 cursor-pointer text-xs">
                <svg
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth="2"
                  ...
                  className="size-3.5 text-foreground mt-0.5 shrink-0"
                >
                ...
                <div className="flex flex-col">
                  <span className="font-semibold flex items-center gap-1.5">
                    <span>GitHub Sync &amp; PR</span>
                    <span className="text-[9px] px-1 py-0.2 bg-emerald-500/15 text-emerald-600 dark:text-emerald-400 rounded font-medium">Safe</span>
                  </span>
                  <span className="text-[10px] text-muted-foreground">Pull &amp; open Pull Request for locales</span>
                </div>
              </DropdownMenuItem>
            )}
            {onOpenSaveProject && (
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-60 max-h-[85vh] overflow-y-auto">
            ...
            {onOpenGitHubSync && (
              <DropdownMenuItem onClick={onOpenGitHubSync} className="gap-2 cursor-pointer text-xs">
                <svg
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth="2"
        ...
        {onOpenCollab && (
          <Button
            ...
            title={
              isCollabConnected
                ? `Live WebRTC Room Active (${collabPeerCount || 1} online)`
