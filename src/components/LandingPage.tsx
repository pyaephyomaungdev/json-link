      ...
      <section id="features" className="w-full py-16 px-4 sm:px-6 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          <Card className="border-border/80 bg-card/60 shadow-xs hover:border-primary/40 transition-colors">
            ...
            <CardContent className="text-xs text-muted-foreground leading-relaxed">
              Export a ready-to-run Vite starter kit or drop <code className="font-mono text-amber-600 dark:text-amber-400">src/locales/</code> into your existing React project with a 50-line reactive client loader, type-safe keys, and native Vite HMR on file save.
            </CardContent>
          </Card>
        </div>
      </section>
