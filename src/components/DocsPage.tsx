...
const FORMAT_LIST = [
  ...
  { name: 'Vite Starter (.zip)', ext: '.zip', desc: 'Ready-to-run React/Vite starter with typed i18n loader & HMR', color: 'text-amber-600 dark:text-amber-400' },
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="p-4 rounded-xl border border-amber-500/25 bg-amber-500/5 space-y-3">
        ...
        <p className="text-[11px] text-muted-foreground leading-relaxed">
          Export an instant, ready-to-run React 19 + Vite 6 starter kit, or drop the <code className="font-mono text-[10px] text-amber-600 dark:text-amber-400">src/locales/</code> directory directly into your existing React project:
        </p>
        <ul className="text-[11px] text-muted-foreground space-y-1.5 list-disc list-inside">
          <li><strong>Zero-Dependency Client Loader:</strong> Includes <code className="font-mono text-[10px]">i18n.ts</code> (&lt; 50 lines) providing a reactive <code className="font-mono text-[10px]">useTranslation()</code> hook, parameter interpolation, and language switching.</li>
          <li><strong>Compile-Time Type Safety:</strong> Autogenerated <code className="font-mono text-[10px]">translations.d.ts</code> gives full TypeScript autocomplete for all keys in your project.</li>
          <li><strong>Native Vite HMR:</strong> Editing any locale JSON immediately updates copy in active browser tabs without a page reload.</li>
          <li><strong>Live In-App Devtools Drawer:</strong> Includes <code className="font-mono text-[10px]">&lt;JsonLinkDevtools /&gt;</code> for in-app search, live copy tweaking with reactive UI updates, and 1-click JSON export.</li>
          <li><strong>Official AI Skill:</strong> Packaged with <code className="font-mono text-[10px]">.agents/skills/jsonlink-vite-i18n/SKILL.md</code> for one-shot agentic scaffolding in Cursor, Claude Desktop, and Antigravity.</li>
        </ul>
      </div>
