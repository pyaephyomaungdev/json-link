    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="p-4 rounded-xl border border-amber-500/25 bg-amber-500/5 space-y-3">
        ...
        <ul className="text-[11px] text-muted-foreground space-y-1.5 list-disc list-inside">
          ...
          <li><strong>Live In-App Devtools Drawer:</strong> Includes <code className="font-mono text-[10px]">&lt;JsonLinkDevtools /&gt;</code> (gated via <code className="font-mono text-[10px]">import.meta.env.DEV</code>) for in-app search, live copy tweaking with reactive UI updates, and 1-click Download / Copy JSON.</li>
          <li><strong>Official AI Skill Bundled in ZIP:</strong> Includes <code className="font-mono text-[10px]">.agents/skills/jsonlink-vite-i18n/SKILL.md</code> inside the exported archive for immediate agentic scaffolding in Cursor, Claude Desktop, and Antigravity.</li>
        </ul>
      </div>
