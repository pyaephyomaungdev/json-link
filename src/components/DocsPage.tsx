...
const FORMAT_LIST = [
  ...
  { name: 'Vite Starter (.zip)', ext: '.zip', desc: 'Export-only React/Vite starter with typed i18n loader & HMR', color: 'text-amber-600 dark:text-amber-400' },
      ...
      <div className="rounded-xl border border-border bg-card p-4 sm:p-5 shadow-xs space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 text-xs">
          ...
          <span className="text-[10px] text-muted-foreground font-medium">
            Core formats support two-way roundtrip • Vite Starter is one-click export
          </span>
        </div>
...
function ExportersSection() {
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      ...
      {/* Feature 1: Vite Plugin & CLI Setup */}
      <div className="p-4 rounded-xl border border-primary/30 bg-primary/5 space-y-3">
        ...
        <div className="p-3 rounded-lg bg-background/90 border border-border/80 font-mono text-[11px] text-foreground space-y-1 relative select-all">
          ...
          <p className="text-emerald-600 dark:text-emerald-400 font-semibold">👉 http://localhost:5173/__jsonlink</p>
        </div>
        <ul className="text-[11px] text-muted-foreground space-y-1.5 list-disc list-inside">
          <li><strong>Zero Extra Ports &amp; Zero Daemons:</strong> Runs directly inside Vite's dev server middleware. No secondary ports to configure or firewall rules to open.</li>
          <li><strong>Direct Disk Two-Way Synchronization:</strong> Edits made in the <code className="font-mono text-[10px]">/__jsonlink</code> spreadsheet write directly back to <code className="font-mono text-[10px]">src/locales/*.json</code> on disk, triggering instant Vite HMR in your active app window.</li>
          <li><strong>Zero Production Footprint:</strong> Configured with <code className="font-mono text-[10px]">apply: 'serve'</code> so zero bytes of plugin or dashboard code are bundled during <code className="font-mono text-[10px]">npm run build</code>.</li>
        </ul>
      </div>

      {/* Feature 2: Drop-in Locales Kit & Standalone Starter */}
      <div className="p-4 rounded-xl border border-amber-500/25 bg-amber-500/5 space-y-3">
        <h3 className="text-xs font-bold text-foreground flex items-center gap-2">
          ...
          <span>Vite Starter Export &amp; Drop-in Locales Kit (Option A vs. B)</span>
        </h3>
        <p className="text-[11px] text-muted-foreground leading-relaxed">
          From the <strong>Export</strong> modal, click <strong>Vite Starter (React)</strong> to download a pre-structured bundle tested on <strong>React 19.0.0</strong> • <strong>Vite 6.0.0</strong> • <strong>TypeScript 5.7.2</strong>:
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
          <div className="p-3 rounded-lg bg-card border border-border/80 space-y-1.5">
            <h4 className="font-bold text-foreground flex items-center gap-1.5">
              <span className="size-4 rounded-full bg-amber-500/15 text-amber-600 dark:text-amber-400 text-[10px] font-mono flex items-center justify-center font-bold">A</span>
              Option A: Drop-in Locales
            </h4>
            <p className="text-[11px] text-muted-foreground leading-relaxed">
              Copy <code className="font-mono text-[10px]">src/locales/</code> into your existing project. Import and use in 3 lines:
            </p>
            <pre className="p-2 rounded bg-muted/50 border border-border/50 text-[10px] font-mono overflow-x-auto text-foreground">
...
return <h1>{t('app.title')}</h1>;`}
          ...
          <div className="p-3 rounded-lg bg-card border border-border/80 space-y-1.5">
            <h4 className="font-bold text-foreground flex items-center gap-1.5">
              <span className="size-4 rounded-full bg-amber-500/15 text-amber-600 dark:text-amber-400 text-[10px] font-mono flex items-center justify-center font-bold">B</span>
              Option B: Standalone Starter
            </h4>
            <p className="text-[11px] text-muted-foreground leading-relaxed">
              Extract the ZIP to a new folder, then install dependencies and run:
            </p>
            <pre className="p-2 rounded bg-muted/50 border border-border/50 text-[10px] font-mono overflow-x-auto text-foreground">
{`npm install
npm run dev
# Complete localized React app ready!`}
            </pre>
          </div>
        </div>
        <ul className="text-[11px] text-muted-foreground space-y-1.5 list-disc list-inside pt-1">
          <li><strong>Zero-Dependency Client Loader:</strong> <code className="font-mono text-[10px]">i18n.ts</code> (~120 lines, 0 external runtime dependencies) provides reactive state, <code className="font-mono text-[10px]">{`{var}`}</code> interpolation, and native Vite HMR.</li>
          <li><strong>Compile-Time Type Safety:</strong> Autogenerated <code className="font-mono text-[10px]">translations.d.ts</code> gives full TypeScript autocomplete and compile errors for missing keys.</li>
          <li><strong>In-App Devtools Drawer:</strong> Mount <code className="font-mono text-[10px]">&lt;JsonLinkDevtools /&gt;</code> in dev mode to live-tweak copy from a floating drawer.</li>
          <li><strong>Bundled AI Skill:</strong> Includes <code className="font-mono text-[10px]">.agents/skills/jsonlink-vite-i18n/SKILL.md</code> for immediate AI assistant discovery in Cursor, Claude Desktop, and Antigravity.</li>
        </ul>
      </div>
